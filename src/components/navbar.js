        ...
        <motion.div variants={pageAnimation} initial="hidden" animate="show">
            <div className={`sidebar ${close ? "close" : ""}`}>
                <div className="logo-details">
                    <i onClick={() => { navToggelHandler() }} className='bx bx-arrow-back'></i>
                    <img className='logo_name' src='image/adhyaaya-logo.png'></img>
                </div>
                <ul className="nav-links">
                    <li onClick={() => { navToggelHandler() }} >
                    ...
                    <li onClick={() => { navToggelHandler() }} >
                        ...
                        <ul className="sub-menu blank">
                            <li><Link to="#" className="link_name" >category</Link></li>
                        </ul>
                    </li>
                    <li onClick={() => { navToggelHandler() }} >
                        <NavLink style={({ isActive }) => {
                        ...
                        <ul className="sub-menu blank">
                            <li><Link to="#" className="link_name" >analytics</Link></li>
                        </ul>
                    </li>
                    <li onClick={() => { navToggelHandler() }} >
                        <NavLink style={({ isActive }) => {
                        ...
                        <ul className="sub-menu blank">
                            <li><Link to="#" className="link_name" >Team</Link></li>
                        </ul>
                    </li>
                    <li onClick={() => { navToggelHandler() }} >
                        <NavLink style={({ isActive }) => {
                        ...
                        <ul className="sub-menu blank">
                            <li><Link to="#" className="link_name" >Calendar</Link></li>
                        </ul>
                    </li>
                    <li>
